...
import biblioteca from "../../../assets/img/bibliotec.jpg"
	...
	return(
		<div className='forgotpwmodal'>
			<div className="rmContent">
				...
				<img src={biblioteca} alt="" className='imagenModal'/>
				<p className="rmGold">Escribe el correo que tienes registrado en tu biblioteca para enviarte las instrucciones de reinicio </p>
				<form>
